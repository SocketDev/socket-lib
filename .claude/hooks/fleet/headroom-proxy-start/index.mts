 ...
 * any startup logs don't leak into Claude Code's session output. BIN_PATH is the
 * lockdown wrapper, so the spawned proxy has telemetry + model fetch forced off.
 */
 ...
 * the env var stays unset and Claude Code falls back to direct api.anthropic.com.
 */
