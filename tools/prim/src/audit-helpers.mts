 ...
 */
export function isBundlerHelperAssignment(
...
export function isDeclarationFile(absPath: string): boolean {
 ...
 */
export function isExportsInteropGlue(node: AstNode): boolean {
 ...
 * findings is noise.
 */
export function isObjectPrototypeIdiom(node: AstNode): boolean {
  return (
 ...
 */
export function isSourceFile(absPath: string): boolean {
