...
/**
 * Bare global functions that aren't on a namespace. Tracked separately because
 ...
 * access. Not standardized — V8 in Node and Chromium only.
...
export function guessReceiverType(name: string): string | undefined {
  ...
  //      collection: Array, List, Vec, or Tuple.
  if (
