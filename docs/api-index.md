...
| Subpath                                                                                | Description                                                                                                                       |
| -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| [`@socketsecurity/lib/eco/category`](../src/eco/category.ts)                           | Socket Registry category tag for packages.                                                                                        |
| [`@socketsecurity/lib/eco/interop`](../src/eco/interop.ts)                             | Module-format interop tag for packages.                                                                                           |
| [`@socketsecurity/lib/eco/manifest`](../src/eco/manifest.ts)                           | Socket Registry manifest schema — per-ecosystem package-list entries used by the registry build pipeline.                         |
