...
**Jump to:** [Top-level](#top-level) · [argv/](#argv) · [constants/](#constants) · [cover/](#cover) · [dlx/](#dlx) · [effects/](#effects) · [env/](#env) · [json/](#json) · [packages/](#packages) · [paths/](#paths) · [releases/](#releases) · [stdio/](#stdio) · [themes/](#themes) · [utils/](#utils) · [validation/](#validation)
...
| Subpath | Description |
| --- | --- |
| [`@socketsecurity/lib/utils/get-ipc`](../src/utils/get-ipc.ts) | Socket CLI IPC object getter. |
