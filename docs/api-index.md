...
**Jump to:** [Top-level](#top-level) · [argv/](#argv) · [constants/](#constants) · [cover/](#cover) · [dlx/](#dlx) · [effects/](#effects) · [env/](#env) · [json/](#json) · [node/](#node) · [packages/](#packages) · [paths/](#paths) · [releases/](#releases) · [schema/](#schema) · [smol/](#smol) · [stdio/](#stdio) · [themes/](#themes)
...
| Subpath                                                            | Description                                                  |
| ------------------------------------------------------------------ | ------------------------------------------------------------ |
| [`@socketsecurity/lib/smol/detect`](../src/smol/detect.ts)         | Detection helper for socket-btm's smol Node binary.          |
| [`@socketsecurity/lib/smol/primordial`](../src/smol/primordial.ts) | Lazy-loader for socket-btm's `node:smol-primordial` binding. |
| [`@socketsecurity/lib/smol/util`](../src/smol/util.ts)             | Lazy-loader for socket-btm's `node:smol-util` binding.       |
