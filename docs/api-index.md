...
**Jump to:** [abort/](#abort) · [ai/](#ai) · [ansi/](#ansi) · [archives/](#archives) · [argv/](#argv) · [arrays/](#arrays) · [bin/](#bin) · [cacache/](#cacache) · [checks/](#checks) · [colors/](#colors) · [compression/](#compression) · [constants/](#constants) · [cover/](#cover) · [crypto/](#crypto) · [debug/](#debug) · [dlx/](#dlx) · [eco/](#eco) · [effects/](#effects) · [env/](#env) · [errors/](#errors) · [fs/](#fs) · [git/](#git) · [github/](#github) · [globs/](#globs) · [http-request/](#http-request) · [ipc-cli/](#ipc-cli) · [ipc/](#ipc) · [json/](#json) · [links/](#links) · [logger/](#logger) · [memo/](#memo) · [node/](#node) · [objects/](#objects) · [packages/](#packages) · [paths/](#paths) · [perf/](#perf) · [pkg-ext/](#pkg-ext) · [primordials/](#primordials) · [proc-lock/](#proc-lock) · [promise-queue/](#promise-queue) · [promises/](#promises) · [regexps/](#regexps) · [releases/](#releases) · [schema/](#schema) · [sea/](#sea) · [shadow/](#shadow) · [signal-exit/](#signal-exit) · [smol/](#smol) · [sorts/](#sorts) · [spawn/](#spawn) · [spinner/](#spinner) · [ssri/](#ssri) · [stdio/](#stdio) · [streams/](#streams) · [strings/](#strings) · [tables/](#tables) · [temporary-executor/](#temporary-executor) · [themes/](#themes) · [ttl-cache/](#ttl-cache) · [types/](#types) · [url/](#url) · [versions/](#versions) · [warnings/](#warnings) · [words/](#words)
...
| Subpath                                                                  | Description                                                                                                                                |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [`@socketsecurity/lib/proc-lock/instance`](../src/proc-lock/instance.ts) | Singleton `processLock` instance — the canonical cross-cutting lock manager.                                                               |
| [`@socketsecurity/lib/proc-lock/manager`](../src/proc-lock/manager.ts)   | `ProcessLockManager` — the class that owns active locks, touch timers, and the exit-handler registration.                                  |
| [`@socketsecurity/lib/proc-lock/types`](../src/proc-lock/types.ts)       | Public type surface for `proc-lock/*` modules — the `ProcessLockOptions` bag accepted by `processLock.acquire` and `processLock.withLock`. |
