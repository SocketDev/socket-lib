...
**Jump to:** [abort/](#abort) · [ai/](#ai) · [ansi/](#ansi) · [archives/](#archives) · [argv/](#argv) · [arrays/](#arrays) · [bin/](#bin) · [cacache/](#cacache) · [cache-with-ttl/](#cache-with-ttl) · [checks/](#checks) · [colors/](#colors) · [compression/](#compression) · [constants/](#constants) · [cover/](#cover) · [crypto/](#crypto) · [debug/](#debug) · [dlx/](#dlx) · [eco/](#eco) · [effects/](#effects) · [env/](#env) · [errors/](#errors) · [fs/](#fs) · [git/](#git) · [github/](#github) · [globs/](#globs) · [http-request/](#http-request) · [ipc-cli/](#ipc-cli) · [ipc/](#ipc) · [json/](#json) · [links/](#links) · [logger/](#logger) · [memoization/](#memoization) · [node/](#node) · [objects/](#objects) · [package-extensions/](#package-extensions) · [packages/](#packages) · [paths/](#paths) · [performance/](#performance) · [primordials/](#primordials) · [process-lock/](#process-lock) · [promise-queue/](#promise-queue) · [promises/](#promises) · [regexps/](#regexps) · [releases/](#releases) · [schema/](#schema) · [sea/](#sea) · [shadow/](#shadow) · [signal-exit/](#signal-exit) · [smol/](#smol) · [sorts/](#sorts) · [spawn/](#spawn) · [spinner/](#spinner) · [ssri/](#ssri) · [stdio/](#stdio) · [streams/](#streams) · [strings/](#strings) · [suppress-warnings/](#suppress-warnings) · [tables/](#tables) · [temporary-executor/](#temporary-executor) · [themes/](#themes) · [types/](#types) · [url/](#url) · [versions/](#versions) · [words/](#words)
...
| Subpath                                                                                | Description                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`@socketsecurity/lib/memoization/clear`](../src/memoization/clear.ts)                 | `clearAllMemoizationCaches` — fan out to every per-cache clear function registered in `_internal.cacheRegistry`.                                                                                               |
| [`@socketsecurity/lib/memoization/decorator`](../src/memoization/decorator.ts)         | `Memoize` — class-method decorator that wraps the decorated method via `memoize`.                                                                                                                              |
| [`@socketsecurity/lib/memoization/memoize`](../src/memoization/memoize.ts)             | `memoize` — synchronous function memoizer with LRU eviction (Map insertion-order based), optional TTL, and optional custom key generator.                                                                      |
| [`@socketsecurity/lib/memoization/memoize-async`](../src/memoization/memoize-async.ts) | `memoizeAsync` — async-aware memoizer with the same LRU+TTL contract as `memoize`, plus thundering-herd dedup.                                                                                                 |
| [`@socketsecurity/lib/memoization/memoize-weak`](../src/memoization/memoize-weak.ts)   | `memoizeWeak` — memoizer keyed by an object reference via `WeakMap`.                                                                                                                                           |
| [`@socketsecurity/lib/memoization/once`](../src/memoization/once.ts)                   | `once` — zero-argument memoizer.                                                                                                                                                                               |
| [`@socketsecurity/lib/memoization/types`](../src/memoization/types.ts)                 | Public type surface for `memoization/*` modules — `MemoizeOptions` is the user-facing options bag accepted by every memoize entrypoint, `CacheEntry<T>` is the internal row stored in each per-function cache. |
...
| Subpath                                                                    | Description                                                                                                                                                                                                                  |
| -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`@socketsecurity/lib/performance/enabled`](../src/performance/enabled.ts) | Feature-flag check — `isPerfEnabled()` returns true when `DEBUG=perf` is set in the environment.                                                                                                                             |
| [`@socketsecurity/lib/performance/metrics`](../src/performance/metrics.ts) | Read-side helpers — `getPerformanceMetrics` returns a shallow copy of the recorded rows, `getPerformanceSummary` rolls them up per operation (count / total / avg / min / max), and `clearPerformanceMetrics` empties the... |
| [`@socketsecurity/lib/performance/report`](../src/performance/report.ts)   | Report-side helpers — `generatePerformanceReport` returns a multi-line ASCII-bordered report string; `printPerformanceSummary` writes a one-line-per-op summary through `debugLog`.                                          |
| [`@socketsecurity/lib/performance/timer`](../src/performance/timer.ts)     | Recording-side helpers — `perfTimer` (returns a stop() closure), `measure` / `measureSync` (timed wrappers around an async / sync function), `perfCheckpoint` (zero-duration marker), and `trackMemory` (records heap-use... |
| [`@socketsecurity/lib/performance/types`](../src/performance/types.ts)     | Public type surface for `performance/*` modules — the `PerformanceMetrics` row shape pushed onto the shared metrics array by `perfTimer` / `measure` / `measureSync` / `perfCheckpoint` / `trackMemory`.                     |
...
| Subpath                                                                                | Description                                                                           |
| -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [`@socketsecurity/lib/temporary-executor/detect`](../src/temporary-executor/detect.ts) | Temporary package executor detection utilities for Socket ecosystem.                  |
| [`@socketsecurity/lib/temporary-executor/types`](../src/temporary-executor/types.ts)   | Public type surface for `temporary-executor/*` modules — currently no exported types. |
