/**
 * @fileoverview Accessor for the vendored `cacache` module. Centralised
 * so other `cacache/*` leaves stay decoupled from the import path —
 * if the vendoring moves, only this leaf updates.
 */
