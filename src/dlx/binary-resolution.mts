...
import libnpmexec from '../external/libnpmexec.js'
...
import { binaryPathCache, binaryPathCacheSet } from './shared.mjs'
 ...
 * getBinFromManifest, which handles aliases and standard cases 2. Fall back to
