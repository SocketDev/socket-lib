/**
 * @file Cache key generation utilities for DLX package installations.
 */

import { hash } from '../crypto/hash'

/**
 * Generate a cache directory name using npm/npx approach. Uses first 16
 * characters of SHA-512 hash (like npm/npx).
 *
 ...
 * - For package installs: Use PURL-style spec with version Examples:
 *   'npm:prettier@3.0.0', 'pypi:requests@2.31.0', 'gem:rails@7.0.0' Note:
 *   Socket uses shorthand format without 'pkg:' prefix (handled by
 *
 * @example
 *   ;```typescript
