...
// because the lib provides it; `sandboxed` is whatever the caller injected,
// if any.
  ...
  async run(
    ...
    try {
      ...
      return {
        ...
        // A signal-kill, which reports a null code, becomes non-zero so it
        // isn't read as success.
