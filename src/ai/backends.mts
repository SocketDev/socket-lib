...
import { isAdaptiveOnlyModel } from './spawn.mjs'
 ...
 * nothing, which skips the pass. Pure — returns the decision + why, never
 * logs. An override that isn't installed is reported via `overrideMissing` so
 * the caller can warn.
 */
