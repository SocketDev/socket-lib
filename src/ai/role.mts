 ...
 *   with mechanical execution dropping to haiku; Opus is reserved for
...
import { AI_PROFILE } from './profiles.mjs'
import { spawnTierWithFallback } from './spawn.mjs'
import type { RouteContext } from './route.mjs'
import type { TierSpawnResult } from './spawn.mjs'
import type { AiTier } from './tier.mjs'
import type { SpawnAiAgentOptions } from './types.mjs'
