/**
 * @fileoverview Line formatting helpers: `applyLinePrefix`,
 * `centerText`, `indentString`, `repeatString`. Plus the
 * `fromCharCode` re-export so callers don't have to reach into
