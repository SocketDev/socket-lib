/**
 * @fileoverview `search` — like `String.prototype.search` but with a
 * configurable starting index. The native `RegExp.exec` + `lastIndex`
 * dance handles this, but with side-effect risk on shared regexes.
 * This wrapper offers a clean, side-effect-free version.
 */
