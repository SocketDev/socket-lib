 ...
 *   precedence, walking up from cwd with the first match winning:
 *
...
import {
  ...
  PNPM_LOCK_YAML,
  YARN_LOCK,
} from './constants/package-managers.mjs'
import {
  getExecPath,
...
import { execNpm } from './npm-cli/exec.mjs'
import { execPnpm } from './pnpm/exec.mjs'
