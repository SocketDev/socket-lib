/**
 * @file Vlt tool surface. Stub — execVlt is not yet implemented in socket-lib.
 ...
 *
 * @internal When implementing, model after eco/npm/npm-cli/exec.ts for
 * array-based args, Windows shell handling, and debug-level filtering.
 */
