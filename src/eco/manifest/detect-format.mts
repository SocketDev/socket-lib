...
import {
  CARGO_LOCK_FILENAME,
  CARGO_LOCK_FORMAT,
} from '../cargo/lockfile-format.mjs'
import {
  CARGO_TOML_FILENAME,
  CARGO_TOML_FORMAT,
} from '../cargo/manifest-format.mjs'
import {
  PACKAGE_JSON_FILENAME,
  PACKAGE_JSON_FORMAT,
} from '../npm/manifest-format.mjs'
import {
  PACKAGE_LOCK_FILENAMES,
  PACKAGE_LOCK_FORMAT,
} from '../npm/npm-cli/lockfile/format.mjs'
import {
  PNPM_LOCK_FILENAME,
  PNPM_LOCK_FORMAT,
} from '../npm/pnpm/lockfile/format.mjs'
import {
  YARN_LOCK_FILENAME,
  YARN_LOCK_FORMAT,
} from '../npm/yarn/lockfile/format.mjs'
...
import type { FormatDescriptor, SupportedFiles } from './types.mjs'
