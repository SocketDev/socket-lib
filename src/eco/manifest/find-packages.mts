 ...
 *   RegExp inputs are hardened via `hardenRegExp` where it is available, which
 *   matches socket-btm's smol behavior. Throws:
 *
...
import { RegExpCtor, RegExpPrototypeTest } from '../../primordials/regexp.mjs'
import { getSmolManifest } from '../../exe/smol/manifest.mjs'

import type { PackageRef, ParsedLockfile } from './types.mjs'
