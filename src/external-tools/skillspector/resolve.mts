 ...
 *
 *   1. VFS — the smol binary's embedded skillspector, when packed
...
import { skillspectorFromDlx } from './from-dlx.mjs'
import { skillspectorFromPath } from './from-path.mjs'
import { skillspectorFromUv } from './from-uv.mjs'
import { skillspectorFromVfs } from './from-vfs.mjs'
