 ...
 *   source in order:
 *
 *   1. VFS — smol binary's embedded OpenGrep, when packed
...
import { opengrepFromDownload } from './from-download.mjs'
import { opengrepFromPath } from './from-path.mjs'
import { opengrepFromVfs } from './from-vfs.mjs'
