 ...
 *   Consumed by `term/colors/convert` and surfaced to downstream renderers
 *   (shimmer, gradient, pulse) that need numeric channel values for color
 *   blending.
 */

import type { ColorName, ColorRgb } from '../types.mjs'
