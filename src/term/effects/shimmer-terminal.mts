 ...
 *   import { renderFrame } from '@socketsecurity/lib/term/effects/shimmer-terminal'
...
import { ANSI_RESET } from '../ansi/constants.mjs'
import { frameColors } from './shimmer.mjs'
import type { RGB, ShimmerSpec } from './shimmer.mjs'
 ...
 * Identical to `ANSI_RESET` in `@socketsecurity/lib/term/ansi`.
 */
export { ANSI_RESET }
 ...
 * emitted without color, forming an uncolored tail.
 *
