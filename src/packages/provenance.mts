...
import { NPM_REGISTRY_URL } from '../eco/npm/constants/package-managers.mjs'
import { getPacoteCachePath } from '../constants/packages.mjs'

import makeFetchHappen from '../external/make-fetch-happen.js'

import {
  createCompositeAbortSignal,
  createTimeoutSignal,
} from '../promises/abort.mjs'
import { parseUrl } from '../url/parse.mjs'

import { isObject } from '../objects/predicates.mjs'

import type { ProvenanceOptions } from './types.mjs'
