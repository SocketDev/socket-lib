...
import { objectEntries } from '../objects/sort.mjs'
import { resolvePackageJsonEntryExports } from './exports.mjs'
import { isRegistryFetcherType } from './validation.mjs'

import type { PackageJson, PacoteOptions } from './types.mjs'

import { ObjectFromEntries, ObjectKeys } from '../primordials/object.mjs'
...
/**
 * Fetch the packument, the package document, for a package.
 *
 * @example
 *   ;```typescript
