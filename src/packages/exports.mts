...
import { LOOP_SENTINEL } from '../constants/sentinels.mjs'
import { isObject, isPlainObject } from '../objects/predicates.mjs'
...
import { ObjectGetOwnPropertyNames } from '../primordials/object.mjs'
...
export function getSubpaths(entryExports: unknown): string[] {
  ...
  // Return the keys of the exports object, which are the subpaths.
