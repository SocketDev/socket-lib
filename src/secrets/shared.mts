 ...
 *   undefined because the entry is missing, `undefined` is cached too —
 *   callers that want a re-check after creating the entry must call
 *   `invalidate`.
 */
 ...
 * don't need it, since process exit drops the cache anyway.
 */
