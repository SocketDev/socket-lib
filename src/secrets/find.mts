 ...
 *   `./shared.ts`. So calling `resolve` multiple times in one process spawns
...
import { readSecretBiometric } from './addon.mjs'
import { requestFromBroker } from './broker.mjs'
import { readSecret, readSecretSync } from './keychain.mjs'
