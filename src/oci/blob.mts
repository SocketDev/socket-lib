/**
 * @file Fetch a blob, either a layer or the config, by digest. `GET
...
import type { OciHttpOptions } from './types.mjs'
...
/**
 * Fetch and parse a JSON blob by digest, typically the image config. Uses the
