...
import colors from '../external/yoctocolors-cjs.js'
...
import { MathFloor, MathMax, MathMin } from '../primordials/math.mjs'
...
export class ProgressBar {
   ...
   *   ```
   *
   * @param current - Current progress value, clamped to total.
