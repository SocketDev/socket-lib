/**
 * @fileoverview Public `escapeRegExp` entry — binds to native
 * `RegExp.escape` (TC39 Stage 4, Node 24+ / V8 13.7) when available,
 * otherwise falls back to the spec-compliant implementation in `./spec`.
 */
