...
import { ArrayCtor, ArrayIsArray } from '../primordials/array.mjs'
...
import { defaultIgnore } from './defaults.mjs'

// Type-only namespace for `typeof` of a dynamically required module; no
// named import yields the whole-module type.
