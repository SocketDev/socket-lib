 ...
 *   sits in `httpDownload`. `httpDownloadAttempt` is exported rather than kept
 *   private, per `export-top-level-functions`. It lives here next to the only
...
import { MathFloor } from '../primordials/math.mjs'
import { NumberIsSafeInteger, NumberParseInt } from '../primordials/number.mjs'
import { PromiseCtor } from '../primordials/promise.mjs'
import { getCrypto, getFs } from './shared.mjs'
...
export async function httpDownload(
  ...
  // and preserves any original file until download succeeds.
