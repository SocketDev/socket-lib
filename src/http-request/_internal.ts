 ...
 * out), so it is not part of the public surface — it exists only as
 * a re-export shim so existing siblings keep working unchanged.
 *
 * New code should import the canonical helpers directly:
