 ...
 *     Exported rather than private so `download.ts` can drive it in stream mode
 *     for its own download-attempt loop.
 */

import { BufferAlloc, BufferConcat } from '../primordials/buffer.mjs'
...
import { getHttp, getHttps } from './shared.mjs'
import { enrichErrorMessage } from './errors.mjs'
import { decodeBody } from './response-reader.mjs'
import { getSocketCallerUserAgent } from './user-agent.mjs'
