...
import { getDebug } from '../env/debug.mjs'
import { getSocketDebug } from '../env/socket.mjs'
import { StringPrototypeStartsWith } from '../primordials/string.mjs'

import { customLog, debugByNamespace, getDebugJs } from './shared.mjs'

import type { DebugOptions, NamespacesOrOptions } from './types.mjs'
