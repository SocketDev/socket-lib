...
import { privateConstructorArgs } from './shared.mjs'
import { buildLoggerSymbols } from './symbols-builder.mjs'
import {
...
import { resolveConsole } from './console.mjs'
import {
  assertMethod,
  countMethod,
  dirMethod,
...
import {
  ...
  progressMethod,
  writeMethod,
} from './stream-methods.mjs'

import type { IndentContext } from './indentation-methods.mjs'

import type { LogSymbols, Task } from './types.mjs'
