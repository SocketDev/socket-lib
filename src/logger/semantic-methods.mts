...
import { stripLoggerSymbols } from './symbols-builder.mjs'
import { incLogCallCountSymbol, lastWasBlankSymbol } from './symbols.mjs'

import type { ConsoleLike, LoggerTrackable } from './console-methods.mjs'
