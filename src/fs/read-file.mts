...
import { normalizeEncoding } from './encoding.mjs'

import type { Abortable } from 'node:events'
import type { ObjectEncodingOptions, PathLike } from 'node:fs'

import type { ReadFileOptions, ReadOptions, SafeReadOptions } from './types.mjs'
 ...
 *
 * @returns Promise resolving to file contents, a string by default, or
 *   undefined on error.
 */
 ...
 * @param options - Read options including encoding and default value.
 *
 * @returns File contents, a string by default, or undefined on error
 */
