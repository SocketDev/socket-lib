...
import type { ReadDirOptions } from './types.mjs'
 ...
 * directory names and never files, with optional filtering for empty
 * directories and glob-based ignore patterns. Results are naturally sorted by
 * default.
 *
 * @example
 *   ;```ts
