...
} from '../primordials/checks/primordials-defaults.mjs'
import { checkPrimordials } from '../primordials/checks/primordials.mjs'
import type {
  PrimordialsCheckConfig,
  PrimordialsCheckResult,
  PrimordialsFinding,
} from '../primordials/checks/primordials.mjs'
...
export function loadConfig(configPath: string): PrimordialsCheckConfig {
  ...
  // primordials config, which keeps single-check setups working.
