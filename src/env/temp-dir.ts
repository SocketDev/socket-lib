/**
 * @file Temporary directory environment variable getters. Different platforms
 *   use different environment variables for temp directories.
 */

import { getEnvValue } from './rewire'

/**
 * TEMP environment variable. Windows temporary directory path.
 *
 * @example
 *   ;```typescript
...
/**
 * TMP environment variable. Alternative temporary directory path.
 *
 * @example
 *   ;```typescript
...
/**
 * TMPDIR environment variable. Unix/macOS temporary directory path.
 *
 * @example
 *   ;```typescript
