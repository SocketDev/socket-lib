...
import { detectArchiveFormat } from '../archives/detect.mjs'
import { extractArchive } from '../archives/extract.mjs'

import type { ArchiveFormat } from '../archives/types.mjs'
...
import { downloadReleaseAsset } from './github-downloads.mjs'
...
export async function downloadAndExtractArchive(
  ...
  const archiveExtension = getArchiveExtension()
  ...
  const archivePath = path.join(
    outputDir,
    `__temp_download__${archiveExtension}`,
  )
