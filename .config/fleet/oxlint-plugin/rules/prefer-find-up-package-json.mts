 ...
 *
 *   Use `findUpPackageJson(import.meta)` — the helper exported by the
 *   fleet lib (`@socketsecurity/lib-stable`) — instead. (The exact
 *   package-helpers subpath has moved across lib releases, so this rule
 *   names the function, not a pinned subpath.)
