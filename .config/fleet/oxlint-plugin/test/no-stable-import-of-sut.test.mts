/**
 * @file Unit tests for the no-stable-import-of-sut oxlint rule. Spawns the real
...
import rule from '../rules/no-stable-import-of-sut.mts'

describe('socket/no-stable-import-of-sut', () => {
  test('valid + invalid cases', () => {
    new RuleTester().run('no-stable-import-of-sut', rule, {
      valid: [
        {
