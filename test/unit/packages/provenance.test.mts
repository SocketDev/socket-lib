...
vi.mock(
  import('../../../src/external/make-fetch-happen.js'),
  () =>
    ({
      default: {
...
describe('packages/provenance — getAttestations', { concurrent: false }, () => {
...
describe('packages/provenance — findProvenance', { concurrent: false }, () => {
...
describe(
  'packages/provenance — getProvenanceDetails',
  { concurrent: false },
  () => {
...
describe(
  'packages/provenance — isTrustedPublisher',
  { concurrent: false },
  () => {
    ...
    it('returns true for github.com URLs', () => {
      ...
      expect(
        isTrustedPublisher('https://api.github.com/repos/owner/repo'),
      ).toBe(true)
    })
    ...
    it('handles @-suffix where first part is also not a URL', () => {
      ...
      expect(isTrustedPublisher('github.com/owner/r@refs/heads/main')).toBe(
        true,
      )
    })
...
describe(
  'packages/provenance — fetchPackageProvenance',
  { concurrent: false },
  () => {
    beforeEach(() => {
