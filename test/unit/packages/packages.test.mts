 ...
 *   resolution utilities for package.json files:
 *
 ...
 *   - Support for scoped packages, node_modules, and monorepo workspaces Used by
 *     Socket tools for package.json file discovery and path manipulation.
 */
...
describe('packages/paths', () => {
  describe('resolvePackageJsonDirname', () => {
    ...
    it('should handle empty string', () => {
      const result = resolvePackageJsonDirname('')
      // Empty string is normalized to '.', the current directory.
      expect(result).toBe('.')
    })
