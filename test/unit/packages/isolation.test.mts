...
describe('packages/isolation — mergePackageJson', { concurrent: false }, () => {
...
describe('packages/isolation — resolveRealPath', { concurrent: false }, () => {
...
describe('packages/isolation — isolatePackage', { concurrent: false }, () => {
