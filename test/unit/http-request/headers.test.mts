...
describe(
  'http-request/headers — isSensitiveHeaderName',
  { concurrent: false },
  () => {
...
describe(
  'http-request/headers — basicAuthHeader',
  { concurrent: false },
  () => {
...
describe(
  'http-request/headers — parseRetryAfterHeader',
  { concurrent: false },
  () => {
...
describe(
  'http-request/headers — sanitizeHeaders',
  { concurrent: false },
  () => {
