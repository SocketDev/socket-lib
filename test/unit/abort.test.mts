/**
 * @file Unit tests for abort signal composition utilities. Tests AbortSignal
 *   composition and timeout utilities:
 *
 ...
 *   - Edge cases: null signals, already-aborted signals, single signals Used by
 *     Socket tools for cancellable async operations and timeout management.
 */
