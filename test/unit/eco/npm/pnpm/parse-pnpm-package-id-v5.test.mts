/**
 * @fileoverview Unit tests for parse-pnpm-package-id-v5.ts.
 */

import { describe, expect, it } from 'vitest'

import { parsePnpmPackageIdV5 } from '@socketsecurity/lib-stable/eco/npm/pnpm/parse-pnpm-package-id-v5'
