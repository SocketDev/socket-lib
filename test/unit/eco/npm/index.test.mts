...
import {
  ...
  isNpmProgressFlag,
} from '@socketsecurity/lib-stable/eco/npm/npm/flags'
import { execPnpm } from '@socketsecurity/lib-stable/eco/npm/pnpm/exec'
import {
  isPnpmFrozenLockfileFlag,
  isPnpmIgnoreScriptsFlag,
  isPnpmInstallCommand,
  isPnpmLoglevelFlag,
} from '@socketsecurity/lib-stable/eco/npm/pnpm/flags'
import { execScript } from '@socketsecurity/lib-stable/eco/npm/script'
import { execYarn } from '@socketsecurity/lib-stable/eco/npm/yarnpkg/yarn/exec'
