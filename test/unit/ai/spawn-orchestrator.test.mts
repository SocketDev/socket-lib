...
describe('ai/spawn — spawnAiAgent happy path', { concurrent: false }, () => {
...
describe(
  'ai/spawn — spawnAiAgent non-overload errors do not retry',
  { concurrent: false },
  () => {
...
describe(
  'ai/spawn — spawnAiAgent retries on overload',
  { concurrent: false },
  () => {
...
describe(
  'ai/spawn — retries without a flag the CLI rejects',
  { concurrent: false },
  () => {
...
describe('ai/spawn — pickAgent', { concurrent: false }, () => {
