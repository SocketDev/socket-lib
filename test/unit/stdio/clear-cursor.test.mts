 ...
 *   in src/stdio/clear:
 *
 *   - hideCursor() / showCursor() toggle DECTCEM cursor visibility
 *   - saveCursor() / restoreCursor() use DECSC/DECRC cursor position sequences
 *   - Combined hide/show and save/restore workflows
 */
