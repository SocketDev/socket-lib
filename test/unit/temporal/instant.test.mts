...
describe(
  'temporal/instant — isValidEpochNanoseconds',
  { concurrent: false },
  () => {
...
describe(
  'temporal/instant — Instant constructor',
  { concurrent: false },
  () => {
...
describe(
  'temporal/instant — epochNanoseconds getter',
  { concurrent: false },
  () => {
...
describe(
  'temporal/instant — describe (value formatter)',
  { concurrent: false },
  () => {
    test('returns "null" for null', () => {
      // The no-null rule bans a `null` literal in source, so derive it via
      // JSON.parse.
