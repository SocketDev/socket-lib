// vitest specs for scripts/fleet/publish.mts isStagingExpected().
//
...
import { isStagingExpected } from '../../../scripts/fleet/publish.mts'
...
describe('publish / main-guard', () => {
  test('importing the module does not run main()', async () => {
    ...
    const mod = await import('../../../scripts/fleet/publish.mts')
