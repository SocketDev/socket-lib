 ...
 *   pricing-data edit that breaks the math is caught. v2 pricing is per-service:
 *   the fixture carries a metered first-party service (anthropic) plus a
 *   flat-rate, plan-billed one (synthetic) to exercise cross-service resolution.
 */
...
const PRICING: PricingData = {
  ...
  services: {
    ...
    synthetic: {
      ...
      models: { 'hf:zai-org/GLM-5.2': { billing: 'plan', contextWindow: 512_000 } },
