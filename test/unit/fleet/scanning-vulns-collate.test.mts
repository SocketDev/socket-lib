...
import { applyScores, assignIds, buildEnvelope, dropEmpty, lightDedupe, lowConfidenceCount, normalizeScore, renderMarkdown, summarizeHandback } from '../../../scripts/fleet/scanning-vulns/lib/collate.mts'
