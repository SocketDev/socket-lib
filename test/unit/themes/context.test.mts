/**
 * @file Unit tests for theme context management. Tests AsyncLocalStorage-based
 *   theme context management for scoped theming:
 *
 *   - getTheme() retrieves the current theme from context
 *   - setTheme() sets the global theme from a name string or a Theme object
 ...
 *     Enables theme isolation across concurrent operations in Socket CLI
 *     tools.
 */
