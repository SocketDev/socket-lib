/**
 * @file Unit tests for sorting and comparison utilities. Tests comparison
 *   functions for array sorting:
 *
 ...
 *   - naturalSorter() factory for natural sort comparisons Used by Socket tools
 *     for sorting package names, versions, and file paths.
 */
