/**
 * @file Unit tests for inter-process locking utilities. Tests file-based
 *   process locking for concurrency control:
 *
 ...
 *   - Cross-platform lock file support Used by Socket CLI to prevent concurrent
