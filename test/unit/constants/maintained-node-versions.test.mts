/**
 * @file Unit tests for maintained Node.js versions data module. Tests
 *   maintained Node.js versions constant:
 *
...
describe('maintained-node-versions', () => {
  ...
  describe('immutability', () => {
    it('should not allow modification of array elements', () => {
      expect(() => {
        // Testing runtime immutability of the readonly array.
    ...
    it('should not allow modification of named properties', () => {
      expect(() => {
        // Testing runtime immutability of the readonly properties.
