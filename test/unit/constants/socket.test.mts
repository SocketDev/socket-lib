/**
 * @file Unit tests for Socket.dev APIs, scopes, organizations, and application
 *   names. Tests Socket ecosystem constants:
 *
 ...
 *   - Config paths: SOCKET_HOME, SOCKET_CONFIG_FILE Frozen constants for Socket
 *     tool configuration.
 */
