/**
 * @file Unit tests for package manager agent constants. Tests package manager
 *   detection and user agent constants:
 *
 *   - Agent names: npm, pnpm, yarn, bun detection
 *   - USER_AGENT strings for HTTP requests
 *   - Package manager version detection Frozen constants for identifying package
