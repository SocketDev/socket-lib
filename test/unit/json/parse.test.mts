/**
 * @file Unit tests for src/json/parse — isJsonPrimitive, parseJson,
 *   prototypePollutionReviver. Split out of the historical monolithic
 *   test/unit/json.test.mts to keep each test file under the fleet's 500-line
 *   soft cap.
 */
