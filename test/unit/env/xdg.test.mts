/**
 * @file Unit tests for XDG Base Directory environment variable getters. Tests
 *   XDG Base Directory Specification getters (freedesktop.org standard):
 *
 ...
 *     Uses rewire for test isolation. Linux/Unix standard for user directory
 *     organization.
 */
