 ...
 *
 *   - resolveColor() resolves semantic color keywords such as primary and
 *     secondary to actual colors
 ...
 *   - Direct color values (non-keywords) pass through unchanged Enables
 *     consistent theming across Socket CLI tools with semantic color names.
 */
