 ...
 *     scripts/fleet/check/lock-step-header.mts # report + fail node
 *     scripts/fleet/check/lock-step-header.mts --json # machine-readable node
 *     scripts/fleet/check/lock-step-header.mts --quiet # silent on clean Exit
