 ...
 * reads its own. Returns `undefined` on missing file or parse error (a malformed
 * package.json is not this gate's concern).
 */
 ...
 * all findings. Pure of process state so callers (CLI + tests) decide reporting.
 */
