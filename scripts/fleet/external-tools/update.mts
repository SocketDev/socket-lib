...
// Audit/cascade script needs sync stdin/stdout + typed string return; v5 lib
// spawnSync omits 'encoding' from SpawnSyncOptions and returns
// string-or-Buffer. v6 lib, when published, will obviate this.
// oxlint-disable-next-line socket/prefer-async-spawn -- audit/cascade script
