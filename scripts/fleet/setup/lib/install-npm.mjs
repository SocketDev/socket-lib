 ...
 *   lib-based path): both read the SAME tools.npm pin + integrity and both drive
 *   the DOWNLOADED `node bin/npm-cli.js install -gf` rather than
 *   `npm install -g npm`, so the resident npm never updates itself. npm is
