/**
 * @file Root-cause analysis, error-history learning, pre-commit scanning, and
 *   success-celebration helpers for the Claude Code utilities CLI.
 */
...
import { runCommandWithOutput } from './claude-core-runners.mts'
