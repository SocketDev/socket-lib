 ...
 * pacote/lib/fetcher.js: Git, Registry, File, Dir, and Remote. The runtime only
 ...
 * constructed.
 *
 * This stub exports a class that throws if instantiated — which would surface
 * an explicit error if a future caller accidentally passes a non-registry spec,
 * rather than silently failing with a misleading downstream error.
 */
'use strict'
