 ...
 * importer to also match, which scopes relative-path stubs to a package.
 */
...
export function getRolldownConfig(
  ...
  // `pkg/*` entries externalize the whole subtree by prefix match; bare
  ...
  return {
    ...
    output: {
      ...
      // matching esbuild's single-outfile bundle.
      codeSplitting: false,
