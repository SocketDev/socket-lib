 ...
 *   `pnpm run audit:consumer-usage --write-stub-list`, committed so the published
    ...
    if (!existsSync(distPath)) {
      throw new Error(
        'build-stubs: a listed leaf has no built dist file.\n' +
          ...
          '  Fix: rebuild first, or regenerate the list with pnpm run audit:consumer-usage --write-stub-list.',
      )
    }
