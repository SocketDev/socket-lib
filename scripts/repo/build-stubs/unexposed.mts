 ...
 *
 *   The leaf list lives in `unexposed-leaves.json` beside this file —
 *   regenerated by `audit-fleet-lib-usage.mts --write-stub-list`, committed
 *   so the published build is reproducible without sibling checkouts.
 */
